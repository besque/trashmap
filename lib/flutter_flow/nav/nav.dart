      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'auth_home')
              : AuthHomeWidget(
        ...
        FFRoute(
          name: 'reportest',
          path: '/reportest',
          builder: (context, params) => ReportestWidget(),
        ),
        FFRoute(
          name: 'hazdisposal',
          path: '/hazdisposal',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'hazdisposal')
              : HazdisposalWidget(),
        ),
        FFRoute(
          name: 'aut_profileCopy',
          path: '/autProfileCopy',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'aut_profileCopy')
              : AutProfileCopyWidget(),
        ),
        FFRoute(
          name: 'ewastedisposal',
          path: '/ewastedisposal',
          builder: (context, params) => EwastedisposalWidget(),
        )
